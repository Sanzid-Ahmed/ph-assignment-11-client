  ...
  return (
    <section className="w-10/12 mx-auto py-24">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="w-full lg:w-5/12 order-2 lg:order-1">
          <motion.div variants={itemVariants} className="mb-10">
            ...
            <p className="text-lg text-base-content/70 mb-8">
              As an HR Manager, you are the architect of the workspace. Manage assets,
              verify employees, and ensure everyone has the tools to succeed.
            </p>
          ...
          <div className="space-y-4">
            {hrFeatures.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ x: 10 }}
                className="flex items-start p-4 bg-base-200 rounded-2xl
        ...
        {/* RIGHT SIDE */}
        <div
          className="w-full lg:w-7/12 order-1 lg:order-2 relative h-[550px]
          bg-base-200 rounded-[3rem] overflow-hidden
          border border-base-300 shadow-inner"
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30">
            <motion.div
              ...
              text-primary-content border-4 border-base-100 shadow-2xl"
            >
          ...
          {[
            ...
            { pos: "bottom-10 right-24", name: "Mike", asset: "Company Hoodie", delay: 1.5 },
          ].map((emp, i) => (
            <React.Fragment key={i}>
              <svg className="absolute inset-0 w-full h-full z-10 text-primary/40">
                <motion.line
                  x1="50%"
                  y1="50%"
              ...
              <motion.div
                ...
                className={`absolute ${emp.pos} z-20 bg-base-100
                p-3 rounded-2xl shadow-lg
                border border-base-300 flex items-center gap-3`}
              >
          ...
          {/* FLOATING UI */}
          <div
            className="absolute top-6 right-6 bg-base-100/80 backdrop-blur-sm
            p-4 rounded-2xl shadow-md border border-base-300 z-40"
          >
            ...
            <div className="flex -space-x-2">
              {[1, 2, 3].map((i) => (
                <div
                  ...
                  border-2 border-base-100 text-[8px]
          ...
          <div
            ...
            bg-base-100/80 backdrop-blur-md px-6 py-2
